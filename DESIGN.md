...
- [solarsystem design](#solarsystem-design)
...
`solarsystem` is designed to allow your to write & deploy serverless apps multi-cloud.

## How is it different from what I already use?

**WORK IN PROGRESS**: `solarsystem` is still in the `design` phase.
...
`solarsystem` is a part of the [Open Source Universe](https://github.com/intellibus/approach). All Projects in the [Open Source Universe](https://github.com/intellibus/approach) follow the same [Contribution Guidelines & Process](https://github.com/intellibus/approach).
...
`solarsystem` only plans to initially support Typescript & JavaScript Applications. However, we would love for the community to contribute versions for other languages (Java, Go, etc.)
